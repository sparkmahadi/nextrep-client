...
const HowItWorks = () => {
    return (
        <div className='px-4 py-7 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8'>
            <h2 className='text-xl md:text-2xl font-bold text-center uppercase divider whitespace-normal lg:whitespace-nowrap'>How it works!</h2>
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-20 pt-5'>
                <div className='bg-sky-700 p-5 rounded-lg text-white'>
