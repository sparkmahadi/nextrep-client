...
const PowerfulBike = () => {
    return (
        <div className='px-4 py-7 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8'>
            <h2 data-aos="fade-left" data-aos-duration="2000" className='text-xl md:text-2xl font-bold text-center uppercase divider whitespace-normal lg:whitespace-nowrap'>World's Most Powerful Bike</h2>
            <div className="hero">
